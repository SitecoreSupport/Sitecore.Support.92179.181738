...
<script type="text/javascript">
	...
	Telerik.Web.UI.Widgets.LinkManager.prototype = {
		...
		setupChildren: function () {
			...
			this._insertSitecoreLink = $find("InsertSitecoreLinkCaller");
		...
		_initializeChildEvents: function () {
            ...
            // ------------------ Sitecore Support fix #181738-----------------------------
			if (this._insertSitecoreLink) {
				this._insertSitecoreLink.add_valueSelected(Function.createDelegate(this, this._insertSitecoreLinkClicked));
            }
            // ------------------ Sitecore Support fix #181738-----------------------------
		...
		// ------------------ Sitecore Support fix #181738-----------------------------
		_insertSitecoreLinkClicked: function (oTool, args) {
			var editor = this._clientParameters.editor;
			editor.fire("InsertSitecoreLink");			
		},
        // ------------------ Sitecore Support fix #181738-----------------------------
					...
					<telerik:RadPageView ID="hyperlinkFieldset" runat="server">
							<asp:PlaceHolder ID="documentCallerRow" runat="server">
									...
									<div class="redRow redToolButton">
										...
										<input type="text" id="LinkURL" class="redInputTool" style="width: 162px"/>
										<div class="redInlineBlock">
										<tools:StandardButton runat="server" ToolName="DocumentManager" ID="DocumentManagerCaller" /></div>
										<div class="redInlineBlock">
										<tools:StandardButton runat="server" ToolName="Insert Sitecore Link" ID="InsertSitecoreLinkCaller" /></div>
									</div>
